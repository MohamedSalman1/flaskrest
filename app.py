...
from api.users.endpoints.auth import ns as users_auth_namespace
...
def configure_app(flask_app):
    ...
    flask_app.config['JWT_SECRET_KEY'] = '123456789-qwerty-poiuytrewq'
...
def initialize_app(flask_app):
    ...
    api.add_namespace(users_auth_namespace)
...
def main():
    initialize_app(app)
    log.info(
        '>>>>> Starting development server at http://{}/api/ <<<<<'
        .format(
